...
class TopSymptomsChart extends ConsumerStatefulWidget {
  final bool isMobile;
  ...
  @override
  ConsumerState<TopSymptomsChart> createState() => _TopSymptomsChartState();
}

class _TopSymptomsChartState extends ConsumerState<TopSymptomsChart> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final data = await repository.getMostFrequentSymptomsInDateRange(
        startDate: startDate,
        endDate: endDate,
        limit: 10,
      );
                        ...
                        BarChartData(
                          ...
                          barTouchData: BarTouchData(
                            touchTooltipData: BarTouchTooltipData(
                              tooltipPadding: const EdgeInsets.symmetric(horizontal: 0, vertical: 8),
                              tooltipMargin: 12,
