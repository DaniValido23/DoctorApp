...
class _$MedicationImpl implements _Medication {
  ...
  @override
  String toString() {
    return 'Medication(id: $id, name: $name, dosage: $dosage, frequency: $frequency, instructions: $instructions)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, dosage, frequency, instructions);
